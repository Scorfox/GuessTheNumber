...
public class NormalGuessNumberGameStrategy : IGuessNumberGameStrategy
{
    ...
    public NormalGuessNumberGameStrategy(
        Player player,
    ...
    public void Start()
    {
        ...
        Console.WriteLine($"The generated number = {GeneratedNumber}");
    }
}